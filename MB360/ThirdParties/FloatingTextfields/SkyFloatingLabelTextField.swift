...
open class SkyFloatingLabelTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    @IBInspectable dynamic open var lineColor: UIColor = .groupTableViewBackground {
        didSet {
            updateLineView()
        }
    }
...
//        print("titlelbl"+titleText!)
        let trimmedString = titleText?.trimmingCharacters(in: .whitespacesAndNewlines)
//        print("trimmedString"+trimmedString!)
        titleLabel.text = trimmedString
